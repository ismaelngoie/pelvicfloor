...
export default function WelcomeStep() {
    ...
    return (
        ...
        <div className="relative h-full w-full flex flex-col justify-between overflow-hidden font-sans pt-safe-top pb-safe-bottom">
            ...
            {/* --- BOTTOM SECTION --- */}
            <div className="z-10 w-full max-w-md mx-auto px-8 pb-10">
                
                {/* Review Ticker */}
                <div className="h-16 flex items-center justify-center relative mb-2">
                    <div key={reviewIndex} className="absolute w-full text-center transition-all duration-700 animate-fade-in px-4">
                ...
                {/* Social Proof */}
                <p className="text-center text-[#737380] text-[15px] mt-4 font-medium">
...
function BenefitRow({ icon, text }: { icon: React.ReactNode, text: string }) {
    return (
        <div className="flex items-start space-x-4">
            ...
            <p className="text-[#1A1A26] text-[16px] font-medium leading-snug">
                {text}
            </p>
        </div>
    );
