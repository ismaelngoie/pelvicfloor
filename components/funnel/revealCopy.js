...
import { TIGHTENING_FOCUS, isMens, isTightening } from "./appCopy";
...
export function revealCta(goalId, focusId) {
  switch (goalId) {
    case "intimacy": return isTightening(focusId) ? "Start My Vaginal Tightening Plan" : "Start My Intimacy Plan";
...
export function dashboardSession(goalId, pathway, focusId) {
  const mens = isMens(pathway);
