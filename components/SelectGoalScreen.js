...
// --- UNIFIED THEME DATA ---
const goals = [
  { id: 'intimacy', title: "Improve Intimacy", icon: <Heart size={32} strokeWidth={1.8} /> },
  { id: 'leaks', title: "Stop Bladder Leaks", icon: <Droplets size={32} strokeWidth={1.8} /> },
  { id: 'pregnancy', title: "Prepare for Pregnancy", icon: <Baby size={32} strokeWidth={1.8} /> },
  { id: 'postpartum', title: "Recover Postpartum", icon: <Activity size={32} strokeWidth={1.8} /> },
  { id: 'core', title: "Build Core Strength", icon: <Zap size={32} strokeWidth={1.8} /> },
  { id: 'pain', title: "Ease Pelvic Pain", icon: <HeartHandshake size={32} strokeWidth={1.8} /> },
  { id: 'fitness', title: "Support My Fitness", icon: <Dumbbell size={32} strokeWidth={1.8} /> },
  { id: 'stability', title: "Boost Stability", icon: <Activity size={32} strokeWidth={1.8} /> },
];
...
export default function SelectGoalScreen({ onNext }) {
  ...
  return (
    <div className="w-full h-full flex flex-col pt-8 px-5 pb-6 animate-fade-in relative bg-app-background/50">
            ...
            return (
              <button
                ...
                className={`
                  ...
                  ${isSelected 
                    ? 'bg-white border-app-primary shadow-xl shadow-app-primary/20 scale-[1.05] z-20' 
                    : 'bg-white border-app-borderIdle hover:border-app-borderIdle/80 z-10'}
                `}
              >
                ...
                {/* Icon */}
                <div className={`mb-3 transition-all duration-300 transform ${isSelected ? 'scale-110 text-app-primary' : 'scale-100 text-app-textSecondary'}`}>
                   {goal.icon}
                </div>
