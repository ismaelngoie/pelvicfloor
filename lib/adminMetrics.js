...
import { DEFAULT_PRICE_AMOUNT, BILLING_INTERVAL, BILLING_INTERVAL_COUNT } from "./pricing";
 ...
 */
// Revenue a subscriber is worth over a year: the price times how many
// billing periods fit in twelve months (one for a yearly plan, twelve for monthly).
export const ANNUAL_PRICE_USD =
  Number(DEFAULT_PRICE_AMOUNT) * (BILLING_INTERVAL === "year" ? 1 : 12 / (BILLING_INTERVAL_COUNT || 1));
