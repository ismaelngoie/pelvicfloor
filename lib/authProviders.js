...
export function providerErrorMessage(code, kind = "") {
  ...
  if (code === "auth/operation-not-allowed" || code === "auth/invalid-credential") {
    ...
    return kind === "apple"
      ...
      : "That way in is not switched on for this site. Email contact@pelvi.health and we will let you in by hand.";
  }
  ...
  if (code === "auth/unauthorized-domain") {
    return "This web address is not approved for sign-in yet. Email contact@pelvi.health and we will let you in by hand.";
  }
  ...
  if (code === "auth/user-disabled") {
    return "That account has been closed. Email contact@pelvi.health and we will sort it out.";
  }
  if (code === "not_configured") {
    return "Sign in is switched off on this deployment. Email contact@pelvi.health and we will open your plan by hand.";
  }
