...
// that branch: nothing writes that object as a gate any more, and reading a
// stale mirror was how a member who had paid an hour ago got a locked door.
// (/api/restore-purchase still writes the object, but only as a record for
// /admin — never as the thing that opens this door.)
//
