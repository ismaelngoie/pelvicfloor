...
export function fixtureLifecycle() {
  const attribution = [
    { campaignId: "1", campaignName: "US | Competitor | Exact", keyword: "pelvic floor coach" },
    { campaignId: "2", campaignName: "US | Category | Exact", keyword: "pelvic floor exercises" },
    { campaignId: "2", campaignName: "US | Category | Exact", keyword: "kegel app" },
    { campaignId: "3", campaignName: "US | Discovery | Search Match", keyword: "" },
    { campaignId: "", campaignName: "", keyword: "" },
  ];
  return attribution.map((entry, index) => ({
    id: `payment-${index + 1}`,
    ...
    transactionId: `payment-transaction-${index}`,
    originalTransactionId: `payment-original-${index}`,
    campaignId: entry.campaignId,
    campaignName: entry.campaignName,
    keyword: entry.keyword,
    mediaSource: entry.campaignId ? "apple_search_ads" : "",
