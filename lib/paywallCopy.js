...
export function showcaseItems(goalId) {
  ...
  return [
    ...
    { icon: "videos", text: "300+ videos approved by physios" },
...
export const REFUND_FAQ_ANSWER =
  "Open the You tab, tap Manage or cancel, and that is it. Or email hello@pelvi.health and we do it for you. No forms, no questions.";
