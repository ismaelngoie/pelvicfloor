...
/**
 * Ends the live line: "Live: 142 members stopping bladder leaks right now."
...
export function goalGerund(goalId) {
  switch (goalId) {
    ...
    case "postpartum": return "recovering postpartum";
    case "coreStrength": return "building core strength";
    case "bladderLeaks": return "stopping bladder leaks";
    case "pelvicPain": return "easing pelvic pain";
    case "intimacy": return "improving intimacy";
    case "fitness": return "supporting their fitness";
    case "stability": return "boosting stability and posture";
    case "diastasisRecti": return "healing diastasis recti";
    default: return "building core strength";
  }
}
