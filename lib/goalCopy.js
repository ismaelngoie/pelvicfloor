...
export function libraryGoalPhrase(goalId, focusId) {
  if (tightening(goalId, focusId)) return "a tighter vagina";
  switch (goalId) {
...
export function pathwaySubtitle(goalId, focusId) {
  if (tightening(goalId, focusId)) return "Tighter, stronger, more feeling. Guaranteed.";
  switch (goalId) {
...
export function goalFeelingQuestion(goalId, focusId) {
  if (tightening(goalId, focusId)) return "How tight and strong do you feel inside today?";
  switch (goalId) {
...
export function goalFeelingTitle(goalId, focusId) {
  if (tightening(goalId, focusId)) return "Tightness Feel";
  switch (goalId) {
...
export function goalPrompt(goalId, focusId) {
  if (tightening(goalId, focusId)) return "How does this tighten my vagina?";
  switch (goalId) {
