...
/**
 * The Stripe price the owner switched on for this amount and period
 * (2026-09-07). functions/api/create-payment-intent.js tries this id first,
 * but only after checking that the price really is active, recurring, in
 * PRICE_CURRENCY, billed every BILLING_INTERVAL and worth PRICE_AMOUNT_CENTS.
 * A stale id therefore cannot sell the wrong amount: it falls through to the
 * product scan. Leave empty to rely on the scan alone.
 */
export const DEFAULT_STRIPE_PRICE_ID = "price_1SuIhbJcZ3jBmTIvpjkDwzJo";
