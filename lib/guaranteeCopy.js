...
// "We'll include" meant "in the email we send you", and nothing in this product
// sends one. See the note above emailTitle in components/funnel/copy.js. The
// guarantee is real and it is written down — on the paywall, on /welcome and in
// the member app — so the line says where it is rather than promising to post
// it.
export const EMAIL_SHIELD_LINE =
  "Your 90-Day Goal Guarantee is set out in writing on the next screen, so you have the terms, not just our word.";
